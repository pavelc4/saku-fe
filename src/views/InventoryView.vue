            ...
            <div class="space-y-6 pt-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    <input v-model="editingProduct.discount" class="w-full bg-surface border-0 border-b-2 border-surface-variant focus:border-primary focus:bg-surface-container-lowest focus:ring-0 pl-4 pr-12 py-3 rounded-t-lg transition-colors text-on-background font-body text-right" type="number" min="0" max="100" placeholder="0"/>
