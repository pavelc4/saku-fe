      ...
      <section class="flex flex-col items-center justify-center p-8 md:p-16 lg:p-24 bg-surface-container-lowest">
        <div class="w-full max-w-md">
          ...
          <div class="grid grid-cols-2 gap-4">
            <button @click="loginWithOAuth('google')" type="button" class="flex items-center justify-center gap-3 py-3 px-4 bg-surface-container-low rounded-xl hover:bg-surface-container-high transition-colors font-medium text-sm text-on-surface">
            ...
            <button @click="loginWithOAuth('github')" type="button" class="flex items-center justify-center gap-3 py-3 px-4 bg-surface-container-low rounded-xl hover:bg-surface-container-high transition-colors font-medium text-sm text-on-surface">
