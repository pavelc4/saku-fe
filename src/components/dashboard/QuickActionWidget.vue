...
const exportPdf = async () => {
  ...
  try {
    ...
    const [transRes, summaryRes, insightRes] = await Promise.all([
      ...
      fetch('/api/insights/daily').then(r => r.json()).catch(() => ({ data: { data: {} } })),
    ]);
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .ai-box { background: #f5f4ed; padding: 20px; border-radius: 12px; margin-top: 24px; }
    .ai-title { font-size: 14px; font-weight: 600; color: #c96442; margin-bottom: 8px; }
...
<body>
  ...
  <table>
    ...
    </tr>`).join('') : '<tr><td colspan="3" style="text-align:center;color:#999;">Tidak ada transaksi</td></tr>'}
  </table>
